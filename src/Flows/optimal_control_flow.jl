...
[`OCPHamiltonianFunction`](@extref), the control `u` is an explicit argument.
...
[`OCPPseudoHamiltonianFunction`](@extref), `g` a [`CTBase.Data.PathConstraint`](@extref)
...
dispatch exactly as for [`OCPPseudoHamiltonianFunction`](@extref).
...
See also: [`OCPPseudoHamiltonianFunction`](@extref), `CTFlows.Flows._ocp_constrained_pseudo_hamiltonian`.
"""
