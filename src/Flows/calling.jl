...
See also: [`CTFlows.Flows._invoke_flow`](@extref), [`CTFlows.Integrators.build_problem`](@extref), `CommonSolve.solve`, [`CTFlows.Trajectories.build_trajectory`](@extref).
"""
...
# See also
[`CTBase.Traits.Fixed`](@extref), `CTBase.Core.NotProvided`, [`CTFlows.Flows._core_invoke_flow`](@extref).
"""
function _invoke_flow(
...
# See also
[`CTBase.Traits.NonFixed`](@extref), [`CTFlows.Flows._core_invoke_flow`](@extref).
"""
function _invoke_flow(
