...
See also: [`CTFlows.Traits.NonFixed`](@ref), [`CTFlows.Traits.VariableDependence`](@ref).
"""
...
See also: [`CTFlows.Traits.Fixed`](@ref), [`CTFlows.Traits.VariableDependence`](@ref).
"""
...
See also: [`CTFlows.Traits.VariableDependence`](@ref), [`CTFlows.Traits.has_variable_dependence_trait`](@ref).
"""
