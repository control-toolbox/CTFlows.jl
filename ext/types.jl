...
# call F.f
function (F::OptimalControlFlow{Fixed})(t0::Time, x0::State, p0::Costate, tf::Time; kwargs...)
...
function (F::OptimalControlFlow{Fixed})(tspan::Tuple{Time, Time}, x0::State, p0::Costate; kwargs...)
    ode_sol = F.f(
        tspan,
        x0,
        p0;
