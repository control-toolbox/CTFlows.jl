function test_types()
    ...
    #
    Fixed = CTFlows.Fixed
    NonFixed = CTFlows.NonFixed
    Autonomous = CTFlows.Autonomous
    NonAutonomous = CTFlows.NonAutonomous
    Mayer = CTFlows.Mayer
    Hamiltonian = CTFlows.Hamiltonian
    HamiltonianVectorField = CTFlows.HamiltonianVectorField
    VectorField = CTFlows.VectorField
    Lagrange = CTFlows.Lagrange
    Dynamics = CTFlows.Dynamics
    StateConstraint = CTFlows.StateConstraint
    MixedConstraint = CTFlows.MixedConstraint
    FeedbackControl = CTFlows.FeedbackControl
    ControlLaw = CTFlows.ControlLaw
    Multiplier = CTFlows.Multiplier
