    ...
    Test.@testset "Concatenation Tests" verbose=VERBOSE showtiming=SHOWTIMING begin
        ...
        Test.@testset "Helpers — multi-phase (AnyMultiPhaseFlow)" begin
            ...
            Test.@testset "get_switching_times" begin
                ...
                Test.@test MultiPhase.get_switching_times(mpstate) ===
                    mpstate.switching_times
        ...
        Test.@testset "StateFlow concatenation" begin
            ...
            Test.@testset "Merge invariant" begin
                ...
                expected_flows = [
                    MultiPhase.get_flows(f1)..., MultiPhase.get_flows(mpf2)...
                ]
                expected_times = [
                    MultiPhase.get_switching_times(f1)...,
                    t_s,
                    MultiPhase.get_switching_times(mpf2)...,
                ]
                expected_jumps = [
                    MultiPhase.get_jumps(f1)..., nothing, MultiPhase.get_jumps(mpf2)...
                ]
