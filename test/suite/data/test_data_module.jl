...
# the expected types are properly exported by `CTFlows.Data` and readily
...
import CTFlows
import CTFlows.Data
using CTFlows.Data  # For testing exported symbols
    ...
    Test.@testset "Data Module Exports" verbose=VERBOSE showtiming=SHOWTIMING begin
        ...
        Test.@testset "Module availability" begin
            Test.@testset "Data module exists" begin
                Test.@test isdefined(CTFlows, :Data)
                Test.@test CTFlows.Data isa Module
            end
        end
